...
public class SearchPolicyID_RL {
	...
	public void SearchPolicyID_RLtest(WebDriver driver,String Url,int Counter) throws Exception {		
			...
			if (Counter==0){
			driver.findElement(By.id("ctl00_MainControls_formPolicyId")).sendKeys(readp.readDatafrom("ResidentialLandlords", "PolicyID1"));
			selenium.keyDown("id=ctl00_MainControls_formPolicyId", "\\9");
			driver.findElement(By.cssSelector("img[alt=\"GO\"]")).click();
			}
			if (Counter==1){
				driver.findElement(By.id("ctl00_MainControls_formPolicyId")).sendKeys(readp.readDatafrom("ResidentialLandlords", "PolicyID2"));
				selenium.keyDown("id=ctl00_MainControls_formPolicyId", "\\9");
				driver.findElement(By.cssSelector("img[alt=\"GO\"]")).click();
			}
			...
			String Basic161 = driver.findElement(By.id("Basic_161_result_span")).getText();
			Basic161 = Basic161.replace( '\u00A3', '*' );
			str11 = Basic161;
			String Basic162 = driver.findElement(By.id("Basic_162_result_span")).getText();
			Basic162 = Basic162.replace( '\u00A3', '*' );
			str12 = Basic162;
			...
			if(Counter==0){
			Assert.assertEquals(str11, readp.readDatafrom("ResidentialLandlords", "TotalGP1"));
			Assert.assertEquals(str12, readp.readDatafrom("ResidentialLandlords", "TotalNP1"));	
			Assert.assertEquals(TPNet, readp.readDatafrom("ResidentialLandlords", "TPNet1"));
			}
			if(Counter==1){
				Assert.assertEquals(str11, readp.readDatafrom("ResidentialLandlords", "TotalGP2"));
