...
public class UnoccupiedPropertyOwnersNew {
	...
	public void testUnoccupiedPropertyOwnersNew(String Url) throws Exception
		{		
			UnoccupiedPropertyOwnersNewtest(driver,Url,Counter);
			Counter=Counter+1;
		}
		public void UnoccupiedPropertyOwnersNewtest(WebDriver driver,String Url, int Counter) throws Exception{		
			...
			{			
				write.CreateNewFiles("UnoccupiedPropertyOwnerNew");
				write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "PolicyID1", "NA");
				write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "PolicyID2", "NA");
				write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalNP1", "NA");
				write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalGP1", "NA");
				write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalNP2", "NA");
				write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalGP2", "NA");
			}		
		...
		{	
			...
			str12 = Basic165;
			PolicyID1=CaseID;
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "PolicyID1", PolicyID1);
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalGP1", str11);
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalNP1", str12);
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TPNet1", TPNet);
		}
		...
		if (Counter == 1)
		{
			...
			str22=Basic165;
			PolicyID2=CaseID;							
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "PolicyID2", PolicyID2);
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalGP2", str21);
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TotalNP2", str22);
			write.WritePropertyFile("UnoccupiedPropertyOwnerNew", "TPNet2", TPNet);
			
			//Compare the stored value from the property file.
			Assert.assertEquals(str21, readp.readDatafrom("UnoccupiedPropertyOwnerNew", "TotalGP1"));
			Assert.assertEquals(str22, readp.readDatafrom("UnoccupiedPropertyOwnerNew", "TotalNP1"));	
			Assert.assertEquals(TPNet, readp.readDatafrom("UnoccupiedPropertyOwnerNew", "TPNet1"));
		}
